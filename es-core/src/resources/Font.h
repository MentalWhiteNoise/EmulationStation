...
#define FONT_SIZE_MINI ((unsigned int)(0.030f * Renderer::getScreenSize()))
#define FONT_SIZE_SMALL ((unsigned int)(0.035f * Renderer::getScreenSize()))
#define FONT_SIZE_MEDIUM ((unsigned int)(0.045f * Renderer::getScreenSize()))
#define FONT_SIZE_LARGE ((unsigned int)(0.085f * Renderer::getScreenSize()))
